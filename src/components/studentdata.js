        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="border p-4 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              <p>
                <span className="font-semibold">{data["BDATE"]}:</span>{" "}
                {studentData.BDATE}
              </p>
              <p>
                <span className="font-semibold">{data["SEX "]}:</span>{" "}
                {studentData.SEX}
              </p>
              <p>
                <span className="font-semibold">{data["Mtongue"]}:</span>{" "}
                {studentData.Mtongue}
              </p>
              <p>
              ...
              <p>
                <span className="font-semibold">{data["caste"]}:</span>{" "}
                {studentData.caste}
              </p>
              <p>
                <span className="font-semibold">{data["C_AILMENT"]}:</span>{" "}
                {studentData.C_AILMENT}
              </p>
              <p>
                <span className="font-semibold">{data["C_AILMENT_INFO"]}:</span>{" "}
                {studentData.C_AILMENT_INFO}
              </p>
              <p>
                <span className="font-semibold">{data["C_INFO "]}:</span>{" "}
                {studentData.C_INFO}
              </p>
          ...
          <div className="border p-4 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 gap-2">
              <p>
                <span className="font-semibold">{data["F_NAME "]}:</span>{" "}
                {studentData.F_NAME}
              </p>
              <p>
                <span className="font-semibold">{data["F_OCC"]}:</span>{" "}
                {studentData.F_OCC}
              </p>
              <p>
                <span className="font-semibold">{data["F_QUALI"]}:</span>{" "}
                {studentData.F_QUALI}
              </p>
              <p>
                <span className="font-semibold">{data["M_NAME "]}:</span>{" "}
                {studentData.M_NAME}
              </p>
              <p>
                <span className="font-semibold">{data["M_OCC"]}:</span>{" "}
                {studentData.M_OCC}
              </p>
              <p>
                <span className="font-semibold">{data["M_QUALI"]}:</span>{" "}
                {studentData.M_QUALI}
              </p>
              <p>
                <span className="font-semibold">{data["G_NAME "]}:</span>{" "}
                {studentData.G_NAME}
              </p>
              <p>
                <span className="font-semibold">{data["M_INCOME"]}:</span>{" "}
                {studentData.M_INCOME}
              </p>
          ...
          <div className="border p-4 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 gap-2">
              <p>
                <span className="font-semibold">{data["P_ADDRESS"]}:</span>{" "}
                {studentData.P_ADDRESS}
              </p>
              <p>
                <span className="font-semibold">{data["P_PHONE"]}:</span>{" "}
                {studentData.P_PHONE}
              </p>
              <p>
                <span className="font-semibold">{data["S_PHONE"]}:</span>{" "}
                {studentData.S_PHONE}
              </p>
              <p>
                <span className="font-semibold">{data["MAIL"]}:</span>{" "}
                {studentData.MAIL}
              </p>
